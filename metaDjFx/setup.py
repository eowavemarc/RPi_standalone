...
son1 = wave.open("/home/pi/metaDjFx/temp/son1.wav","rb")
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList1[i+a*len(frameList1)//size])
	somme = somme*0.0003
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList1r[i+a*len(frameList1r)//size])
	somme = somme*0.0003
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList2[i+a*len(frameList2)//size])
	somme = somme*0.0003
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList2r[i+a*len(frameList2r)//size])
	somme = somme*0.0003
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList3[i+a*len(frameList3)//size])
	somme = somme*0.0003
...
while (a<size):
	somme = 0
	for i in range(10):
		somme = somme+ abs(frameList3r[i+a*len(frameList3r)//size])
	somme = somme*0.0003
...
fichier = open("/home/pi/metaDjFx/temp/var.txt","w")
